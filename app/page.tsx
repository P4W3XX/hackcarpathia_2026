        ...
        {currentPage === "career" && (
          <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 p-8">
            <div className="max-w-5xl mx-auto">
              ...
              {/* Live Preview of Custom Career Path While Adding Levels */}
              {showLevelForm && customLevels.length > 0 && customCareerPath && (
                <div className="mb-12">
                  <h3 className="text-2xl font-bold text-white mb-6">👁️ Podgląd Ścieżki</h3>
                  <CareerProgress
                    levels={customCareerPath.levels}
                    userProgress={progressWithCalculatedLevel}
                  />
                </div>
              )}
